...
class VisionAnalyzerTests(unittest.TestCase):
    ...
    def test_analyzer_builds_image_first_request_and_wraps_provenance(self) -> None:
        ...
        self.assertEqual(artifact.artifact_version, "1.3")
        self.assertEqual(len(artifact.geometry_hints), 1)
        self.assertEqual(len(artifact.geometry_hints[0].enclosed_regions), 1)
    ...
    def test_truncated_structured_output_is_rejected(self) -> None:
        ...
        with (
            ...
            self.assertRaises(AnalyzerResponseError),
        ):
